...
#define     PWM0_HIGH_MAX   (PWM0_DUTY - PWM0_HIGH_MIN)     //??PWM?????????
#define     PWM1_DUTY       3000        //??PWM???,???PCA???????????
#define     PWM1_HIGH_MIN   80          //??PWM?????????
#define     PWM1_HIGH_MAX   (PWM1_DUTY - PWM1_HIGH_MIN)     //??PWM?????????
#define     PWM2_DUTY       2000        //??PWM???,???PCA???????????
#define     PWM2_HIGH_MIN   80          //??PWM?????????
#define     PWM2_HIGH_MAX   (PWM2_DUTY - PWM2_HIGH_MIN)     //??PWM?????????
/********************************************************************************************/
#define PCA0            0
#define PCA1            1
#define PCA2            2
...
typedef struct
{
    ...
    u8  PCA_Polity; //????? PolityHigh,PolityLow
    u16 PCA_Value;
} PCA_InitTypeDef;
