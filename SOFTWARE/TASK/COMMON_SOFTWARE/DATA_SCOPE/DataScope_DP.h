...
#define DATA_TO_CHANNEL_4 4
#define DATA_TO_CHANNEL_5 5
#define DATA_TO_CHANNEL_6 6
#define DATA_TO_CHANNEL_7 7
#define DATA_TO_CHANNEL_8 8
#define DATA_TO_CHANNEL_9 9
#define DATA_TO_CHANNEL_10 10
...
extern void sendScopeData(float Data, u8 channel);
